...
if (document.URL.includes("ome") || document.URL.includes("ome") || document.URL === 'https://science-calc.com/' || document.URL === 'https://flourishing-bubblegum-5c730a.netlify.app') {
    lightDarkCookie();
    lightDarkMode();
    phoneMode('h');
